...
class Ownermywalks extends StatefulWidget {
  const Ownermywalks({super.key});

  @override
  _OwnermywalksState createState() => _OwnermywalksState();
}

class _OwnermywalksState extends State<Ownermywalks> {
  ...
  Future<List<Walk>> getOwnerBids() async {
    ...
    final response = await http
        .post(Uri.parse("$API_URL/owner-my-walks"), body: {}, headers: {
